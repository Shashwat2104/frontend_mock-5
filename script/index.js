...
function toggleForm(e) {
  ...
  loginForm.style.display = loginToggler.classList.contains("active")
    ? "block"
    : "none";
  signupForm.style.display = signupToggler.classList.contains("active")
    ? "block"
    : "none";
}
...
signupForm.addEventListener("submit", (e) => {
  ...
  fetch("https://mock-5-xpu6.onrender.com/api/signup", {
    method: "POST",
    headers: {
...
loginForm.addEventListener("submit", (e) => {
  ...
  fetch("https://mock-5-xpu6.onrender.com/api/login", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
